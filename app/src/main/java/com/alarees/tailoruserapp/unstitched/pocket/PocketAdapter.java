...
class PocketAdapter extends BaseAdapter {
    Context context;
    PocketViewModel livedata;
    ArrayList<TypeModel> models;
    LayoutInflater inflter;
    public PocketAdapter(Context context,ArrayList<TypeModel> models) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewclick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                livedata = ViewModelProviders.of((FragmentActivity) context).get(PocketViewModel.class);
