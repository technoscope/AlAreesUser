...
class CuffAdapter extends BaseAdapter {
    Context context;
    CuffViewModel livedata;
    ArrayList<TypeModel> models;
    LayoutInflater inflter;
    public CuffAdapter(Context context, ArrayList<TypeModel> models) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewclick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                livedata = ViewModelProviders.of((FragmentActivity) context).get(CuffViewModel.class);
