...
class CollarAdapter extends BaseAdapter {
    Context context;
    CollarViewModel livedata;
    ArrayList<TypeModel> models;
    LayoutInflater inflter;
    public CollarAdapter(Context context, ArrayList<TypeModel> models) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewclick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                livedata = ViewModelProviders.of((FragmentActivity) context).get(CollarViewModel.class);
